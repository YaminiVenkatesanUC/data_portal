...
renderPlot({
  hist(df_ind_views$ind_views[df_ind_views$indicator_name == input$indicator])
})
```
...
-----------------------------------------------------------------------
### Wordcloud - most popular - over time
...
wordcloud2(data = tail(ind_views_total, 25), size = 0.4,minRotation = 0, maxRotation = 0, color = col_vec)
```

### Wordcloud - least popular - over time

```{r}
col_vec2 <- rep(c("#FFBABA", "#FF7B7B", "#FF5252", "#FF0000", "#A70000"), 5)
#hwordcloud(text = ind_views_total$indicator_name, size = ind_views_total$count, width = "100%", )
wordcloud2(data = head(ind_views_total, 25), size = 0.4,minRotation = 0, maxRotation = 0, color = col_vec2)
```
