...
data <- read.csv("~/Network-Shares/J-Drive-WLG-Shared/Indicators_aotearoa/Covid-19/Portal Data Supply/SEEA GHG Emissions/Covid-portal-ghg-emissions-sept-20.csv")
